...
function parseSchedule(html,sport,icon){
  ...
  var games=[];
  var nd=$("script#__NEXT_DATA__").html();
  if(nd){
    try{
...
app.get("/api/standings",function(_,res){
...
app.post("/api/cache/bust",function(_,res){
